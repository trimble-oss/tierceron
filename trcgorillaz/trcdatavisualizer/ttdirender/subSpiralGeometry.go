...
func NewSphere(radius float64, widthSegments, heightSegments int) *geometry.Geometry {
...
func NewSphereSector(radius float64, widthSegments, heightSegments int, phiStart, phiLength, thetaStart, thetaLength float64) *geometry.Geometry {

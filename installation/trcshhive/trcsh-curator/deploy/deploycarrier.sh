...
cp target/trc-vault-carrier-plugin$PROD_EXT $VAULT_PLUGIN_DIR
chmod 700 $VAULT_PLUGIN_DIR/trc-vault-carrier-plugin$PROD_EXT
sudo setcap cap_ipc_lock=+ep $VAULT_PLUGIN_DIR/trc-vault-carrier-plugin$PROD_EXT
fi

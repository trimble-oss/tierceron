...
var file_trcshtalksdk_trcshtalksdk_proto_rawDesc = []byte{
	...
	0x6c, 0x6f, 0x12, 0x1a, 0x2e, 0x74, 0x72, 0x63, 0x73, 0x68, 0x74, 0x61, 0x6c, 0x6b, 0x73, 0x64,
	0x6b, 0x2e, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x18,
	0x2e, 0x74, 0x72, 0x63, 0x73, 0x68, 0x74, 0x61, 0x6c, 0x6b, 0x73, 0x64, 0x6b, 0x2e, 0x48, 0x65,
	0x6c, 0x6c, 0x6f, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x22, 0x00, 0x42, 0x4f, 0x5a, 0x4d, 0x67, 0x69,
	...
	0x6e, 0x73, 0x74, 0x61, 0x6c, 0x6c, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x2f, 0x74, 0x72, 0x63, 0x6c,
	0x6f, 0x63, 0x61, 0x6c, 0x2f, 0x74, 0x72, 0x63, 0x68, 0x65, 0x6c, 0x6c, 0x6f, 0x77, 0x6f, 0x72,
	0x6c, 0x64, 0x2f, 0x68, 0x65, 0x6c, 0x6c, 0x6f, 0x73, 0x64, 0x6b, 0x62, 0x06, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x33,
}
...
var file_trcshtalksdk_trcshtalksdk_proto_goTypes = []any{
	(*HelloRequest)(nil), // 0: trcshtalksdk.HelloRequest
	(*HelloReply)(nil),   // 1: trcshtalksdk.HelloReply
}
var file_trcshtalksdk_trcshtalksdk_proto_depIdxs = []int32{
	0, // 0: trcshtalksdk.Greeter.SayHello:input_type -> trcshtalksdk.HelloRequest
	1, // 1: trcshtalksdk.Greeter.SayHello:output_type -> trcshtalksdk.HelloReply
...
func file_trcshtalksdk_trcshtalksdk_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_trcshtalksdk_trcshtalksdk_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_trcshtalksdk_trcshtalksdk_proto_msgTypes[1].Exporter = func(v any, i int) any {

...
type EditOptions struct {
	...
	OriginalResult *memresource.Result
	...
	f                   memfactory.Factory
	editPrinterOptions  *editPrinterOptions
	updatedResultGetter func(data []byte) *memresource.Result
...
func (o *EditOptions) Complete(f memfactory.Factory, args []string, cmd *cobra.Command) error {
	var err error
	...
	o.updatedResultGetter = func(data []byte) *memresource.Result {

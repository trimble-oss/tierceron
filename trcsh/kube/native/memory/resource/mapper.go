...
type mapper struct {
	...
	clientFn     func(version schema.GroupVersion) (resource.RESTClient, error)
...
func (m *mapper) infoForData(data []byte, source string) (*resource.Info, error) {
...
func (m *mapper) infoForObject(obj runtime.Object, typer runtime.ObjectTyper, preferredGVKs []schema.GroupVersionKind) (*resource.Info, error) {

...
func (clientConfigFn ClientConfigFunc) clientForGroupVersion(gv schema.GroupVersion, negotiatedSerializer runtime.NegotiatedSerializer) (resource.RESTClient, error) {
...
func (clientConfigFn ClientConfigFunc) unstructuredClientForGroupVersion(gv schema.GroupVersion) (resource.RESTClient, error) {
	cfg, err := clientConfigFn()
	if err != nil {
		return nil, err
	}

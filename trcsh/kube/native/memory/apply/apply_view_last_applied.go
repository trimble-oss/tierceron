...
func NewCmdApplyViewLastApplied(f memfactory.Factory, ioStreams genericclioptions.IOStreams) *cobra.Command {
...
func (o *ViewLastAppliedOptions) Complete(cmd *cobra.Command, f memfactory.Factory, args []string) error {

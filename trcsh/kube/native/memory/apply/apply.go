...
func NewCmdApply(baseName string, f memfactory.Factory, ioStreams genericclioptions.IOStreams) *cobra.Command {
...
func (o *ApplyOptions) Complete(f memfactory.Factory, cmd *cobra.Command) error {
	var err error

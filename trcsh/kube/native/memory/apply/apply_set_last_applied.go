...
func NewCmdApplySetLastApplied(f memfactory.Factory, ioStreams genericclioptions.IOStreams) *cobra.Command {
...
func (o *SetLastAppliedOptions) Complete(f memfactory.Factory, cmd *cobra.Command) error {
	var err error

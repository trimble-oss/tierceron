...
import (
	...
	memeditor "github.com/trimble-oss/tierceron/trcsh/kube/native/memory/editor"
...
func NewCmdApplyEditLastApplied(f memfactory.Factory, ioStreams genericclioptions.IOStreams) *cobra.Command {
	o := memeditor.NewEditOptions(memeditor.ApplyEditMode, ioStreams)

...
var data []string = []string{"TestOne", "TestTwo", "TestThree", "TestFour"}

// var TimeData = map[string][]float64{
// 	data[0]:  []float64{0.0, .2, .95, 4.13, 100.85, 212.85},
// 	data[0]:  []float64{0.0, .2, .95, 4.13, 200.85, 312.85},
// 	data[0]:  []float64{0.0, .2, .95, 4.13, 300.85, 412.85},
// 	data[0]:  []float64{0.0, .2, .95, 4.13, 400.85, 512.85},
// }

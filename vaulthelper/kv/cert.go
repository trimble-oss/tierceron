...
// Package kv generated by go-bindata.// sources:
...
func CertsCert_filesDcipublicPem() (*asset, error) {
	...
	info := bindataFileInfo{name: "../../certs/cert_files/dcipublic.pem", size: 2626, mode: os.FileMode(511), modTime: time.Unix(1571146823, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}

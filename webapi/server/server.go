...
func (s *Server) getPaths(config *eUtils.DriverConfig, mod *kv.Modifier, pathName string) ([]string, error) {
...
func (s *Server) getTemplateFilePaths(config *eUtils.DriverConfig, mod *kv.Modifier, pathName string) ([]string, error) {
	secrets, err := mod.List(pathName)
	pathList := []string{}
	if err != nil {
		eUtils.LogErrorObject(config, err, false)
...
func (s *Server) templateFileRecurse(config *eUtils.DriverConfig, mod *kv.Modifier, pathName string) ([]string, error) {
	subPathList := []string{}

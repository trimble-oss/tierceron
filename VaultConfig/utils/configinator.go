...
func ConfigTemplate(modifier *kv.Modifier, emptyFilePath string, configuredFilePath string, publicPath string, privatePath string) {
	...
	populatedTemplate := PopulateTemplate(publicPath, privatePath, empTemplate, modifier)
